function [Xc,Z]= bgs_airPLS(X,lambda,order,wep,p,itermax)
    %  BGS_AIRPLS Baseline correction using adaptive iteratively reweighted Penalized Least Squares;		
    %  Input 
    ...
    %  Examples:
    %         Xc = BGS_AIRPLS(X);
    %         [Xc,Z] = BGS_AIRPLS(X,10e9,2,0.1,0.5,20);
    %  Reference:
